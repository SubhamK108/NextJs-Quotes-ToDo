...
import { QuotesRequestResult, getQuote } from "./quotes-api";

export default async function Quotes(): Promise<ReactElement> {
  const [quote, requestResult]: [Quote, QuotesRequestResult] = await getQuote();

  return (
    <div>
      {requestResult !== "GET_FAIL" ? (
        <div className="h-full flex flex-col justify-center items-center text-center">
          <QuotesHeader />
          <QuotesDisplay Quote={quote} RequestResult={requestResult} />
          <Link href="/todos">
